...
const Header = () => {
    return (
        <div className='flex mt-3 max-w-[95%] mx-auto justify-between bg-slate-400 p-4 items-center'>
            ...
            <div className= 'max-w-[250px] 2xl:max-w-[500px] text-center bg-[#401B0C] text-white p-2 rounded-2xl'>
                <h1 className='italic max-w-[250px] md:w-[500px] font-black text-lg 2xl:text-6xl'>MAA BHAVANI  </h1>
                <h3 className='italic max-w-[250px] md:w-[500px] font-bold text-lg 2xl:text-4xl'>SARI CENTER</h3>
            </div>
