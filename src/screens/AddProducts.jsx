              ...
              <form className="space-y-6" onSubmit={event => {
                ...
                <div className='flex gap-3'>
                  <div className="flex flex-col">
                    <label className="text-lg font-semibold mb-2" htmlFor="vender.name">vender Name</label>
                    <input
                      name="vender.name"
                      type="text"
                      value={values.vender.name}
                      onChange={handleChange}
                  ...
                  <div className="flex flex-col">
                    <label className="text-lg font-semibold mb-2" htmlFor="vender.mobile">vender Mobile</label>
                    <input
                      name="vender.mobile"
                      type="text"
                      value={values.vender.mobile}
                      onChange={handleChange}
                      placeholder="vender Mobile No."
                      className="px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-yellow-500"
                    />
                  </div>
                  <div className="flex flex-col">
                    <label className="text-lg font-semibold mb-2" htmlFor="vender.mobile">Vender address</label>
                    <input
                      name="vender.mobile"
                      type="text"
                      value={values.vender.address}
                      onChange={handleChange}
                      placeholder="vender Mobile No."
                      className="px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-yellow-500"
                    />
